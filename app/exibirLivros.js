...
function exibirLivros(listaLivros) {
  ...
  const buttonsFechar = document.querySelector('#btnFecharModal');
  const buttonsUpload = document.querySelector('#btnCadastrarLivros');

  const modalUpload = document.querySelector("#modal-upload");
  const fade = document.querySelector("#fade");

  const toggleModal = () => {
    modalUpload.classList.toggle("hide");
    fade.classList.toggle("hide");
  };

  [buttonsUpload, buttonsFechar, fade].forEach((el) => {
